(function($) { "use strict";
	...
	jQuery(".main-content,.main-content > .-inner-content,.main-content > .-inner-content > .the-main-container").css({"min-height":"calc( 100vh - "+header_footer+"px )"});
...
jQuery.noConflict()(function _sidebar() {
	StickySidebarContent();
});
